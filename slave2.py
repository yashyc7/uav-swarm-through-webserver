...
print("===================" + ipAddr + "===================")
drone = Drone(
    useSitl=True, port="5790", ID="3", ip=ipAddr
)  # make sure IP specified here matches IP of the device
...
drone.arm_and_takeoff(
    float(drone.get_data_from_server("/dronedata", {"droneID": "1"})["altitude"])
)
print("=========================================")
