...
print("=====================MASTER=======================")
print("===================" + ipAddr + "===================")
drone = Drone(useSitl=True, port="5780", ID="1", ip=ipAddr)
...
while (
    drone.get_drone_data()["mode"] != "ALT_HOLD" and counter < 120
):  # if pilot doesn't take over in x seconds, it breaks
...
print(
    "===========SCRIPT_TAKING_CONTROL_WAITING_FOR_DRONE_TO_ENTER_GUIDED_MODE================="
)
counter = 0
while (
    drone.get_drone_data()["mode"] != "GUIDED" and counter < 20
):  # if vehicle mode doesn't switch within x seconds move on to the land and shutdown which should also attempt to switch to guided.
    print("Counter: ", counter)
    counter = counter + 1
